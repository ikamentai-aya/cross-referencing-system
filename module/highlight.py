...
def highlightTextList(text_list, path_coordinate_dict, path_text_dict, save_path, content, paragraph_coordinate_dict, new_area_section_index):
    ...
    for text in text_list:
        coodinate, page = findSpace(text, content, paragraph_coordinate_dict, new_area_section_index)
...
def highlightParagraph(file_name, index):
    ...
    #print(paragraph_coordinate_dict)
    ...
    image_list, page_list = highlightTextList([s], path_coordinate_dict, path_text_dict, save_path, content, paragraph_coordinate_dict, new_area_section_index)
    if len(page_list) >0:
